...
/** getPictureOutPaintingTaskResult GET /api/picture/out_painting/get_result */
export async function getPictureOutPaintingTaskResultUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getPictureOutPaintingTaskResultUsingGETParams,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseGetOutPaintingTaskResponse_>(
    '/api/picture/out_painting/get_result',
    {
      method: 'GET',
      params: {
        ...params,
...
/** searchPictureByPictureRequest POST /api/picture/search/picture */
export async function searchPictureByPictureRequestUsingPost(
